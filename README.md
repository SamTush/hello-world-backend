...
Hello-world-backend app is a react application that gets data from a rails API.
...
**[Hello-world-backend]** Hello-world-backend app is a rail api application that sends json data from a React Application.
...
```
  cd my-folder
  git clone https://github.com/SamTush/hello-world-frontend.git
```
### react

[React app](https://github.com/SamTush/hello-world-frontend/pull/1)
